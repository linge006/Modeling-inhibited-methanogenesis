...
C_Na <- Q_Na/V_fluid									# HNO3 oncentration
C_Ni <- Q_Ni/V_fluid									# HNO2 oncentration
...
P_Na_InNa <- D_DMI*c_HNO3 # Inflow from feed

U_Na_NaAb <- k_NaAb*Q_Na # Absorption of HNO3
U_Na_NaEx <- k_FlEx*Q_Na # Fractional outflow

U_Na_NaNi <- k_NaNi*Q_Mi*Q_Na*Q_Hy # Nitrate reduction to nitrite
...
P_Ni_NaNi <- U_Na_NaNi # Nitrite production from nitrate reduction

U_Ni_NiAb <- k_NaAb*Q_Ni # Absorption of HNO2
U_Ni_NiEx <- k_FlEx*Q_Ni # Fractional outflow

U_Ni_NiAm <- k_NiAm*Q_Mi*Q_Ni*Q_Hy # Nitrite reduction to ammonia
...
U_Hy_HyMe <- (v_HyMe*Q_Me) / (1+M_Hy_HyMe/C_Hy+C_Ni/J_Ni_HyMe) # Methanogenesis 
U_Hy_NaNi <- Y_Hy_NaNi * U_Na_NaNi # Hydrogen utilization for Nitrate reduction
U_Hy_NiAm <- Y_Hy_NiAm * U_Ni_NiAm # Hydrogen utilization for Nitrite reduction
...
# Fermentable OM that reaches the hindgut is calculated from fiber leaving the rumen, starch that is still not degraded in the 
# small intestine, protein fraction of bacteria and archaea; the latter is taken twice to get a rough estimate of the intestinally 
# degraded rumen undegradable protein.
...
# hydrogenase catalyzed NADH oxidation via confurcation; U_NADH_Fe is set zero for F_T_Fd < 0
...
dNa <- P_Na_InNa - U_Na_NaAb - U_Na_NaEx - U_Na_NaNi 
dNi <- P_Ni_NaNi - U_Ni_NiAb - U_Ni_NiEx - U_Ni_NiAm
...
dHy <- P_Hy_HeAc + P_Hy_HeBu - U_Hy_HyMe - U_Hy_NaNi - U_Hy_NiAm - U_Hy_HyEm - U_Hy_HyEx 
...
dNaIn <- P_Na_InNa # Inflow from feed
dNaAb <- U_Na_NaAb # Absorption of HNO3
dNaEx <- U_Na_NaEx # Fractional outflow
dNaNi <- U_Na_NaNi # Nitrate reduction to Nitrite
dNiAb <- U_Ni_NiAb # Nitrate reduction to Nitrite
dNiEx <- U_Ni_NiEx # Nitrate reduction to Nitrite
dNiAm <- U_Ni_NiAm # Nitrate reduction to Nitrite

### list all variables to be returned

list(c(dFd,dSd,dWr,dNa,dNi,dHe,dMi,dAc,dPr,dBu,dHy,dMe,dNAD,dMt,dNaIn,dNaAb,dNaEx,dNaNi,dNiAb,dNiEx,dNiAm),c(D_DMI=D_DMI,P_Fd_InFd=P_Fd_InFd,U_Fd_FdHe=U_Fd_FdHe,U_Fd_FdEx=U_Fd_FdEx,
	P_Sd_InSd=P_Sd_InSd,U_Sd_SdHe=U_Sd_SdHe,U_Sd_SdEx=U_Sd_SdEx,P_Wr_InWr=P_Wr_InWr,U_Wr_WrHe=U_Wr_WrHe,U_Wr_WrEx=U_Wr_WrEx,
	P_Na_InNa=P_Na_InNa,U_Na_NaAb=U_Na_NaAb,U_Na_NaEx=U_Na_NaEx,U_Na_NaNi=U_Na_NaNi,C_Na=C_Na,
	P_Ni_NaNi=P_Ni_NaNi,U_Ni_NiAb=U_Ni_NiAb,U_Ni_NiEx=U_Ni_NiEx,U_Ni_NiAm=U_Ni_NiAm,C_Ni=C_Ni,
	...
	P_Hy_HeAc=P_Hy_HeAc,P_Hy_HeBu=P_Hy_HeBu,U_Hy_HyMe=U_Hy_HyMe,U_Hy_HyEm=U_Hy_HyEm,U_Hy_NaNi=U_Hy_NaNi,U_Hy_HyEx=U_Hy_HyEx,
