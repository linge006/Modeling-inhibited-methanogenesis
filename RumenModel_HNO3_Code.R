...
# feedintake is a dataframe containing the feed intake rate per period of 12 h
...
U_Na_NaAm <- k_NaAm*Q_Mi*Q_Na*Q_Hy # Nitrate reduction to ammonia
...
U_Hy_HyMe <- (v_HyMe*Q_Me) / (1+M_Hy_HyMe/C_Hy) # Methanogenesis 
U_Hy_NaAm <- Y_Hy_NaAm * U_Na_NaAm # Hydrogen utilization for Nitrate reduction to ammonia
...
dNa <- P_Na_InNa - U_Na_NaAb - U_Na_NaEx - U_Na_NaAm
...
dHy <- P_Hy_HeAc + P_Hy_HeBu - U_Hy_HyMe - U_Hy_NaAm - U_Hy_HyEm - U_Hy_HyEx 
...
dNaAm <- U_Na_NaAm # Nitrate reduction to ammonia

f_NADH <- (f_NADH*c_NAD*Q_Mi + dNAD*delt)/(c_NAD*Q_Mi) # NADH as a fraction of NAD^+ + NADH

### list all variables to be returned

list(c(dFd,dSd,dWr,dNa,dHe,dMi,dAc,dPr,dBu,dHy,dMe,dNAD,dMt,dNaIn,dNaAb,dNaEx,dNaAm),c(D_DMI=D_DMI,P_Fd_InFd=P_Fd_InFd,U_Fd_FdHe=U_Fd_FdHe,U_Fd_FdEx=U_Fd_FdEx,
	P_Sd_InSd=P_Sd_InSd,U_Sd_SdHe=U_Sd_SdHe,U_Sd_SdEx=U_Sd_SdEx,P_Wr_InWr=P_Wr_InWr,U_Wr_WrHe=U_Wr_WrHe,U_Wr_WrEx=U_Wr_WrEx,
	P_Na_InNa=P_Na_InNa,U_Na_NaEx=U_Na_NaEx,U_Na_NaAm=U_Na_NaAm,C_Na=C_Na,
	...
	P_Hy_HeAc=P_Hy_HeAc,P_Hy_HeBu=P_Hy_HeBu,U_Hy_HyMe=U_Hy_HyMe,U_Hy_HyEm=U_Hy_HyEm,U_Hy_NaAm=U_Hy_NaAm,U_Hy_HyEx=U_Hy_HyEx,
